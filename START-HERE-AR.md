...
### 2) أعد تشغيل العميل من أيقونة شريط المهام

لا بالضغط على ✕ — وإلا بقي يعمل في الخلفية بالإعداد القديم.

### 3) ⚠️ فعّل موصل `excalidraw` بالزر

في **Claude Desktop**: قائمة الموصلات ← فعّل `excalidraw`.
